...
define('UL_SITE_KEY', 'vvrPOFjS41241l432fadsf456AADsdDSds77dsaDF');
...
define('UL_SITE_ROOT_DIR', dirname(__FILE__) . '/../../..');
...
define('UL_SESSION_BACKEND', 'ulPhpDefaultSessionStorage');
...
define('UL_SESSION_CHECK_IP', false);
