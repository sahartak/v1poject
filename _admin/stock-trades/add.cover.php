...
function addNewTradeCover($tradesBuy_id=0) {
...
<div class="hintHolder ui-state-default"><b>'.(($_GET['action']=='new_sell')?'Adding new':'Editing').' COVER Order</b></div>
<script type="text/javascript" src="../js/jquery.metadata.js"></script> 
<script type="text/javascript" src="../js/jquery.validate.js"></script>
<script type="text/javascript" src="js/forms/stradesCover.js"></script>
...
<form name="addNewTradeCover" method="POST" id="MainForms" action="">
...
<div class="left">
	...
	<div class="formsRight">BUY TO COVER</div>
	<br />
...
<div class="left">
	...
	<input type="hidden" name="_add_cover" value="1" />
	<input type="hidden" name="trid" value="'.$tradesBuy_id.'">
