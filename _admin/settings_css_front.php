...
if(isset($_POST['_submit'])) {
	...
	echo '
	<div class="successHolder">'.getLang('hints_styles_front_success').'</div>';
	
	addLog('Back-end','Front-end Settings',0,''.$_SESSION['admin']['name'].' ('.$_SESSION['admin']['refnum'].')','CSS styles edited');
}

echo '
	<div class="hintHolder ui-state-default"><b>'.getLang('hints_styles_front_title').':</b></div> 
