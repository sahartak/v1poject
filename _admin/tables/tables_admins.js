...
$(document).ready(function() {
	...
	"fnDrawCallback": function( oSettings ) {
	    $('#adminsTable tbody tr').click( function() {
		var iPos = oTable.fnGetPosition( this );
		window.location = "users_admins.php?action=edit&username="+oSettings.aoData[iPos]._aData[0];
	    } );
	},
	"bProcessing": true,
	"bServerSide": true,
	"bAutoWidth": false,
	"sAjaxSource": "tables/tables_admins.php",
	"bJQueryUI": true,
	"bSortClasses": false,
    ...
    $("#adminsTable tbody").mouseover(function(event) {
