...
$(document).ready(function() {
	...
	"fnDrawCallback": function( oSettings ) {
		$('#advisorsTable tbody tr a').click( function() {
			link=$(this).attr("href");
	    ...
	    $('#advisorsTable tbody tr').click( function() {
			...
			window.location = "stocks.php?action=new_stock&ref="+oSettings.aoData[iPos]._aData[0];
	    } );
	},
	"bProcessing": true,
	"bServerSide": true,
	"bAutoWidth": false,
	"sAjaxSource": "tables/tables_stocks.php",
	"bJQueryUI": true,
	"bSortClasses": false,
