...
$(document).ready(function() {
	...
	"fnDrawCallback": function( oSettings ) {
		...
		window.location = "expiry_dates.php?action=edit&edid="+oSettings.aoData[iPos]._aData[0];
	    } );
	},
	"bProcessing": true,
	"bServerSide": true,
	"bAutoWidth": false,
	"sAjaxSource": "tables/tables_expiry_dates.php",
	"bJQueryUI": true,
	"bSortClasses": false,
    ...
    $("thead input").bind('keyup change', function() {
