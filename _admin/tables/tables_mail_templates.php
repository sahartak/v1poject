...
$searchColumns=array('mail_templates_id','mail_template_title');
$searchLimit='';
...
$searchQuery='SELECT SQL_CALC_FOUND_ROWS * FROM mail_templates '.$searchFor.' '.$searchOrder.' '.$searchLimit.'';
...
$query='SELECT COUNT(mail_templates_id) AS total_groups FROM mail_templates';
$res=$db->rq($query);
$row=$db->fetch($res);
