...
$(document).ready(function() {
	...
	"fnDrawCallback": function( oSettings ) {
		...
		if (whatType.match(/BUY.*?/)) {
		    window.location = "trades.php?action=edit_buy&tref="+oSettings.aoData[iPos]._aData[0];
		}else{
		    window.location = "trades.php?action=edit_sell&tref="+oSettings.aoData[iPos]._aData[0];
		}
	    });
	},
	...
	"bServerSide": true,
	"bAutoWidth": false,
	"sAjaxSource": "tables/tables_trades.php",
	"bJQueryUI": true,
	"bSortClasses": false,
