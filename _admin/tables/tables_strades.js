...
$(document).ready(function() {
	...
	"fnDrawCallback": function( oSettings ) {
	    $('#tradesTable tbody tr a').click( function(e) {
	    ...
	    $('#tradesTable tbody tr').click( function() {
		var iPos = oTable.fnGetPosition( this );
		whatStatus=oSettings.aoData[iPos]._aData[10];
		whatType=oSettings.aoData[iPos]._aData[3];
		if (whatType.match(/BUY.*?/)) {
		    window.location = "strades.php?action=edit_buy&tref="+oSettings.aoData[iPos]._aData[0];
		}else{
		    window.location = "strades.php?action=edit_sell&tref="+oSettings.aoData[iPos]._aData[0];
		}
	    });
	},
	...
	"bServerSide": true,
	"bAutoWidth": false,
	"sAjaxSource": "tables/tables_strades.php",
	"bJQueryUI": true,
	"bSortClasses": false,
    ...
    $("#tradesTable tbody").mouseover(function(event) {
